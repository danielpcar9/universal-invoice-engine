...
<Invoice xmlns="urn:oasis:names:specification:ubl:schema:xsd:Invoice-2"
  ...
  <cac:AccountingSupplierParty>
    <cac:Party>
      ...
      <cac:PartyTaxScheme><cbc:CompanyID>FR123456789</cbc:CompanyID></cac:PartyTaxScheme>
    </cac:Party>
  </cac:AccountingSupplierParty>
  <cac:AccountingCustomerParty>
    <cac:Party>
      <cac:PartyName><cbc:Name>Customer Corp</cbc:Name></cac:PartyName>
    ...
    <cac:PayeeFinancialAccount>
      ...
      <cac:FinancialInstitutionBranch>
        <cac:FinancialInstitution>
          <cbc:ID schemeID="BIC">SOGEFRPP</cbc:ID>
        </cac:FinancialInstitution>
      </cac:FinancialInstitutionBranch>
    </cac:PayeeFinancialAccount>
  </cac:PaymentMeans>
...
def test_parse_valid_peppol_invoice():
    ...
    assert parsed.tax_amount == Decimal("200.00")
    assert parsed.creditor_iban == "FR1420041010050500013M02606"
    assert parsed.creditor_bic == "SOGEFRPP"
